...
export default function Test4({ showToggle = true, type = 'password' }) {
    ...
    return (
        <div className='w-full max-h-screen py-0 bg-bg text-text flex flex-col items-center justify-center -z-1 overflow-hidden'>
                ...
                <div className='w-4xl h-full flex flex-col items-center justify-center'>
                    ...
                    <div className='w-md flex flex-col gap-4'>
                        ...
                        <div >
                            ...
                            <div className='border border-border-20 rounded-2xl text-sm relative overflow-hidden backdrop-blur-2xl group bg-muted-bg'>
                                <input className='outline-0 h-full w-full p-3 px-4 z-9 relative' type="text" placeholder='Enter Enrollment Number' />
                                <div className="w-full aspect-square bg-accent fixed top-30 rounded-full left-0 z-1 blur-[2vh] group-focus-within:top-8 transition-all duration-200 ease-in-out"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className='flex items-center relative'>
                                ...
                                <div className='relative group/pass'>
                                    ...
                                    <div className='text-xs overflow-hidden text-text absolute w-xl z-9999 bg-muted-bg backdrop-blur-xl rounded-xl border py-3.5 px-10 border-border-20 bottom-4 left-4 opacity-0 group-hover/pass:opacity-100 transition-all ease-in-out duration-300 pointer-events-none'>
                            ...
                            <div className='border border-border-20 pr-4 rounded-2xl text-sm relative overflow-hidden backdrop-blur-2xl group bg-muted-bg flex items-center'>
                        ...
                        <div className='relative'>
                            ...
                            <div className='flex items-center gap-2'>
                                ...
                                <div className='border border-border-20 rounded-2xl text-lg relative overflow-hidden backdrop-blur-2xl group bg-muted-bg flex items-center justify-center w-14 aspect-square cursor-pointer'>
                                    <i className="ph ph-arrows-clockwise relative z-9"></i>
                                    <div className="w-6 aspect-square bg-accent fixed top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full left-1/2 z-1 blur-[1vh] group-focus-within:top-0 transition-all duration-200 ease-in-out"></div>
                                </div>
                            </div>

                            <h1 className='text-center text-sm font-dot z-9 absolute mt-2 text-accent'>For ERROR!</h1>
                        </div>

                        {/* Submit */}
                        <div className='mt-18'>
                            <div className='border border-border-20 text-text rounded-full p-1.5 cursor-pointer active:scale-95 bg-[#fe330a]/90 text-sm relative overflow-hidden backdrop-blur-2xl group bg-blac transition-all duration-200 ease-in-out'>
                                <h1 className='text-center text-lg font-dot z-9 relative'>Login</h1>
                            </div>
                            <p className='text-center text-xs text-muted-text mt-2'>Data is fetched directly from GGSIPU Exam Portal.</p>
                        </div>
