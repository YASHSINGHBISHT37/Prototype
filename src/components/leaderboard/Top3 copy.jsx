...
export default function Top3() {
    return (
        <div className='w-full flex items-end justify-center gap-4 h-130'>
            ...
            <div className='flex flex-col gap-3 '>
                ...
                <div className='w-90 h-55 rounded-3xl cursor-pointer hover:h-65 transition-all duration-200 ease-in-out border border-black/20 bg-black/3 flex items-center justify-center overflow-hidden relative'>
            ...
            <div className='flex flex-col gap-3'>
                ...
                <div className='w-90 h-80 rounded-3xl cursor-pointer hover:h-90 transition-all duration-200 ease-in-out border border-black/20 bg-black/3 items-center overflow-hidden relative flex flex-col justify-center'>
            ...
            <div className='flex flex-col gap-3 '>
                ...
                <div className='w-90 h-40 rounded-3xl cursor-pointer border hover:h-50 transition-all duration-200 ease-in-out border-black/20 bg-black/3 flex items-center justify-center overflow-hidden relative'>
